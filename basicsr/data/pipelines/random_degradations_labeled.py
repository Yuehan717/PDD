...
class RandomBlurLabeled:
    ...
    def get_kernel(self, num_kernels):
        ...
        for _ in range(0, num_kernels):
            ...
            labels.append((Label_ids[f'blur_{kernel_type}'], (sigma + 1)//1.))
    ...
    def _apply_gaussian_noise(self, imgs, seq_prob):
        ...
        for img in imgs:
            if np.random.uniform() > seq_prob:
                ...
                labels.append((Label_ids['noise_gaussian'], sigma//10.+1.))
                # update noise level
    ...
    def _apply_poisson_noise(self, imgs, seq_prob):
        ...
        for img in imgs:
            if np.random.uniform() > seq_prob:
                ...
                labels.append((Label_ids['noise_poisson'], scale//1.+1))
...
@PIPELINE_REGISTRY.register()
class RandomJPEGCompressionLabeled:
    ...
    def _apply_random_compression(self, imgs, seq_prob):
        ...
        for img in imgs:
            if np.random.uniform() > seq_prob:
                ...
                labels.append((Label_ids['jpeg'], jpeg_param//30.+1.))
...
allowed_degradations = {
    'RandomBlurLabeled': RandomBlurLabeled,
    'RandomNoiseLabeled': RandomNoiseLabeled,
    'RandomJPEGCompressionLabeled': RandomJPEGCompressionLabeled,
}


@PIPELINE_REGISTRY.register()
class DegradationsWithSamplingLabeled:
